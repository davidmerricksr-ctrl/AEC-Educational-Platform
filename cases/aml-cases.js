...
const AML_CASES = [
  // ── CASE 1: Classic Structuring / Smurfing ──
  {
    ...
    network: {
      nodes: [
        { id:0, label:"D. Lunaro", type:"customer", x:170, y:45, info:"Primary subject. 8-month account, declared income $42K, but $138K in cash deposits in 14 days." },
        { id:1, label:"Branch 1–3", type:"bank", x:55, y:115, info:"3 branches visited on the same day. All deposits just below the $10K CTR threshold." },
        { id:2, label:"Branch 4–7", type:"bank", x:285, y:115, info:"4 more branches within 14 days. Pattern consistent with smurfing across locations." },
        { id:3, label:"Corvado Trading", type:"company", x:75, y:205, info:"LLC registered in New Mexico 4 months ago. No web presence. Single-member entity." },
        { id:4, label:"Palmspur Imports", type:"company", x:265, y:205, info:"Panama-registered import company. No verifiable business records found." },
        { id:5, label:"Panama 🇵🇦", type:"jurisdiction", x:170, y:245, info:"FATF increased-monitoring list. Known deficiencies in AML transparency." },
      ],
  ...
  // ── CASE 2: PEP with Unexplained High-Value Wires ──
  {
    ...
    network: {
      nodes: [
        { id:0, label:"Y. Krestova", type:"customer", x:170, y:38, info:"Senior Foreign PEP. Former advisor, Ministry of Energy. Pension $85K but moving $2.1M." },
        { id:1, label:"Vyranthos Hldgs", type:"company", x:50, y:125, info:"UAE registered. Nominee director. No public filings. Received $1.54M from subject." },
        { id:2, label:"Thessalora Prop.", type:"company", x:290, y:125, info:"Cyprus property developer. $320K wire received. Cyprus flagged for AML weaknesses." },
        { id:3, label:"Soleira Estates", type:"company", x:50, y:215, info:"Spanish luxury real estate. €245K Mediterranean property purchase in progress." },
        { id:4, label:"Volstran Resources", type:"company", x:290, y:215, info:"Russian resource company. $250K incoming wire — source of wealth unclear." },
        { id:5, label:"UAE 🇦🇪", type:"jurisdiction", x:120, y:248, info:"Over $1.5M in outgoing wires. Opaque corporate ownership structures." },
        { id:6, label:"Cyprus 🇨🇾", type:"jurisdiction", x:230, y:248, info:"EU member, previously grey-listed. Popular for Russian capital flows." },
      ],

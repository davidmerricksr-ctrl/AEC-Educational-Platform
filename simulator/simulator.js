...
function openAML(c){
  ...
  renderNetworkAML(c.network,c.transactions);renderCategorizedFlags('aml-flags',c.flags);document.getElementById('aml-notes').value=state.notes[c.id]||'';
